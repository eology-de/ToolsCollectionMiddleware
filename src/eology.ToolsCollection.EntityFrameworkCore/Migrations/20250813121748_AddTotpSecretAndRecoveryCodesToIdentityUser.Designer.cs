...
{
    [DbContext(typeof(ToolsCollectionDbContext))]
    [Migration("20250813121748_AddTotpSecretAndRecoveryCodesToIdentityUser")]
    partial class AddTotpSecretAndRecoveryCodesToIdentityUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eology.ToolsCollection.Features.SerpItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("EO_SerpItems", (string)null);
                });

            modelBuilder.Entity("eology.ToolsCollection.Features.SerpQueueItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("QueryResultSerialized")
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("EO_SerpQueueItems", (string)null);
                });
            ...
            modelBuilder.Entity("eology.ToolsCollection.Features.SerpQueueItem", b =>
                {
                    b.HasOne("eology.ToolsCollection.Features.SerpItem", "Parent")
                        .WithMany("QueueItems")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
